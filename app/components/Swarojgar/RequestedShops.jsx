...
const RequestedShops = () => {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                const shopsRef = collection(FIRESTORE_DB, "SwarozgarRequests");
            ...
            <View style={styles.container}>
                {error ? (
                    ...
                    shopsList.map((shop) => (
                        ...
                        <View key={shop.id}>
                            <TouchableOpacity
                            onPress={()=>navigation.navigate('ShopHomePage',{ shop:shop,requested:true })}
                            >
                                <View style={styles.card}>
                                    ...
                                    <View style={styles.details}>
                                        ...
                                        {/* <Text style={styles.time}>Closing Time: {formatTime(shop.closingTime)}</Text> */}
                                    </View>
                                </View>
                            </TouchableOpacity>
                        </View>
